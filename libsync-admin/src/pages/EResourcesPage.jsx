...
export default function EResourcesPage() {
  ...
  const fetchResources = async () => {
    try {
      ...
      const response = await axios.get(`${API_BASE_URL}/eresources/admin/all`, {
  ...
  const saveResource = async () => {
    try {
      ...
      if (isEditing) {
        await axios.put(`${API_BASE_URL}/eresources/admin/${editingResource._id}`, resourceData, {
          headers: { Authorization: `Bearer ${token}` }
        });
        showNotification('E-resource updated successfully');
      } else {
        await axios.post(`${API_BASE_URL}/eresources/admin/create`, resourceData, {
          headers: { Authorization: `Bearer ${token}` }
        });
  ...
  const deleteResource = async () => {
    try {
      const token = localStorage.getItem('adminToken');
      await axios.delete(`${API_BASE_URL}/eresources/admin/${resourceToDelete._id}`, {
        headers: { Authorization: `Bearer ${token}` }
      });
