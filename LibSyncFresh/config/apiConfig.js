...
class ApiConfig {
  ...
  async getBaseURL() {
    if (this.baseURL) {
      console.log('Using cached baseURL:', this.baseURL);
      return this.baseURL;
    }
    ...
    try {
      ...
      console.log('Stored IP from AsyncStorage:', storedIP);
      if (storedIP) {
    ...
    // If no stored IP, try to auto-detect
    console.log('No stored IP found, attempting auto-detection...');
